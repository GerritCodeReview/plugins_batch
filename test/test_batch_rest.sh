...
STATUS="$(get)"
rest_result "$STATUS" "302" "RestAPI Endpoint"
...
rest_result "$STATUS" "200" "Delete - Valid Batch ID"
...
STATUS="$(delete "batches/?""$id")"
rest_result "$STATUS" "400" "Delete - Invalid Batch ID"

# DELETE BATCH - No Batch ID Provided
# https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/400
STATUS="$(delete "batches/?")"
rest_result "$STATUS" "400" "Delete - No Batch ID"
