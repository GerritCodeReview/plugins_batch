...
public class BatchQueryBuilder extends QueryBuilder<Batch> {
  ...
  public BatchQueryBuilder(
      ProjectCache projectCache, PluginConfigFactory cfgFactory, BatchStore store) {
    super(mydef);
  ...
  public Date getExpiry() throws NoSuchProjectException {
    Config config = cfgFactory.getProjectPluginConfig(projectCache.getAllProjects(), "batch");
    long seconds =
