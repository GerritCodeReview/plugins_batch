...
public class BatchRemover {
  protected RefUpdater refUpdater;
  ...
  public Batch remove(String id)
      throws IllegalStateException, IOException, IntegrationException, RepositoryNotFoundException {
  ...
  protected void removeDownloadRefs(Batch batch) throws IOException, RepositoryNotFoundException {
